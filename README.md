...
当前版本是一个后端 MVP，重点展示后端工程能力和 AI Agent 工作流：通过 FastAPI 接口导入仓库、扫描源代码、提取符号、构建本地检索索引，并基于仓库上下文完成问答、分析和生成任务。
...
- 支持生成架构分析、Bug 分析、PR Review 和 README 草稿。
